...
class EditBeritaKelas extends StatefulWidget {
  const EditBeritaKelas({Key? key}) : super(key: key);

  @override
  State<EditBeritaKelas> createState() => _EditBeritaKelasState();
}

class _EditBeritaKelasState extends State<EditBeritaKelas> {
