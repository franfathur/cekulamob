...
class BuatBeritaKelas extends StatefulWidget {
  const BuatBeritaKelas({Key? key}) : super(key: key);

  @override
  State<BuatBeritaKelas> createState() => _BuatBeritaKelasState();
}

class _BuatBeritaKelasState extends State<BuatBeritaKelas> {
