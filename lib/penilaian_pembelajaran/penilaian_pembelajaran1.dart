...
import 'package:template7/penilaian_pembelajaran/penilaian_pembelajaran2.dart';

class PenilaianPembelajaran1 extends StatelessWidget {
  const PenilaianPembelajaran1({Key? key}) : super(key: key);
